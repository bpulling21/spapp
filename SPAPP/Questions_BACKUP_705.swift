...
>>>>>>> 6eaa83a89484e9e1911f2e760eece271e930637b
...
let question5 = spappQuestion(
    question: "In 1932, what did the Spence School do to stay open?",
...
let question12 = spappQuestion(
    question: "How many girls did Ms. Spence originally have?",
    choice1:"5",
    choice2:"10",
    choice3:"15",
    choice4:"20",
...
let question13 = spappQuestion(
    question: "What did Clara Spence do before starting her own school?",
...
let question30 = spappQuestion(
    question: "Which students can use the elevator during the day?",
...
let question31 = spappQuestion(
    question: "Which was required of Spence girls in the early years?",
